  ...
  return (
    <aside className="w-64 shrink-0 hidden md:block border-r border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 p-4 transition-colors min-h-[calc(100vh-4rem)]">
      <div className="space-y-6 sticky top-20">
        ...
        <div className="p-3.5 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-50 dark:from-slate-850 dark:to-slate-800/80 border border-slate-200 dark:border-slate-700/80 shadow-sm space-y-3">
          ...
          <div className="space-y-1.5 text-[11px] text-slate-600 dark:text-slate-400">
            ...
            <div className="flex items-center justify-between">
              <span>Sheet:</span>
              <span className="font-medium text-slate-700 dark:text-slate-300">Sheet1</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="inline-flex items-center text-emerald-600 dark:text-emerald-400 font-semibold text-[10px]">
                <CheckCircle2 className="w-3 h-3 mr-0.5" /> Verified 1:1
              </span>
            </div>
          </div>
        </div>
